...
const registrar = async (req, res) =>{
    ...
    await check('telefono').isLength({ min: 9, max: 9 }).withMessage('El telefono debe tener 9 caracteres').run(req) 
    ...
    const {nombre,apellido,telefono,fechaNacimiento, email, password,documento,identificacion} = req.body
